...
//      m_iShells, m_iBullets, m_iRockets, m_iGrenades, m_iElectricity, m_iIronBalls); 
  ...
  void SetProperties(void)
  {
    ...
    if( m_iShells != 0) {m_strDescription.PrintF("%s: Shells (%d)", m_strDescription.ConstData(), m_iShells);}
    if( m_iBullets != 0) {m_strDescription.PrintF("%s: Bullets (%d)", m_strDescription.ConstData(), m_iBullets);}
    if( m_iRockets != 0) {m_strDescription.PrintF("%s: Rockets (%d)", m_strDescription.ConstData(), m_iRockets);}
    if( m_iGrenades != 0) {m_strDescription.PrintF("%s: Grenades (%d)", m_strDescription.ConstData(), m_iGrenades);}
    if( m_iNapalm != 0) {m_strDescription.PrintF("%s: Napalm (%d)", m_strDescription.ConstData(), m_iNapalm);}
    if( m_iElectricity != 0) {m_strDescription.PrintF("%s: Electricity (%d)", m_strDescription.ConstData(), m_iElectricity);}
    if( m_iIronBalls != 0) {m_strDescription.PrintF("%s: Iron balls (%d)", m_strDescription.ConstData(), m_iIronBalls);}
//    if( m_iNukeBalls != 0) {m_strDescription.PrintF("%s: Nuke balls (%d)", m_strDescription.ConstData(), m_iNukeBalls);}
    if( m_iSniperBullets != 0) {m_strDescription.PrintF("%s: Sniper bullets (%d)", m_strDescription.ConstData(), m_iSniperBullets);}
  }
