...
ENGINE_API extern void *_debug_AllocMemory(size_t memsize, int iType, const char *strFile, int iLine);
ENGINE_API extern void *AllocMemoryAligned(size_t memsize, SLONG slAlignPow2);
